...
if __name__ == '__main__':
  ...
  folder_path = "./checkpoint/SQUARE_Mamba_Not_Quantum.pkl"
  ...
  gt_csv.to_csv("./Result/SQUARE_Mamba_Not_Quantum/gt_Pooncarie.csv", header=None, index=False)
  prediction_csv.to_csv("./Result/SQUARE_Mamba_Not_Quantum/prediction_Pooncarie.csv", header=None, index=False)
